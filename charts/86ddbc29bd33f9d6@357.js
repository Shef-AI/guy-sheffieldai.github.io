...
// md`# Sheffield Graph Knowledge 
// Visualizing Knowledge and Information of Researcher at [The University of Sheffield](/index.html).`
// )});
  main.variable(observer("chart")).define("chart", ["partition","data","d3","width","color","arc","format","radius"], function(partition,data,d3,width,color,arc,format,radius)
{
  ...
  const svg = d3.select("#chartSection").append("svg")
